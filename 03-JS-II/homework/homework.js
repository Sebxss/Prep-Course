...
function saludo(idioma) {
  ...
  // Tu código:
  if(idioma === "aleman"){ //Al ser strings se manejan las comillas dobles , siempre que que sea string . Usar comillas
    return "Guten Tag!";
...
function esVerdadero(valor){
  ...
  if( valor === true ){ // cada vez que vayamos a recibir un valor booleano es true o false 
